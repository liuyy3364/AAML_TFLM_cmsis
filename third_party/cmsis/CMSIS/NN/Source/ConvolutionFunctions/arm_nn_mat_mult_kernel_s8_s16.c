                                    ...
                                    q7_t *out_0)
{
    ...
    while (row_count)
    {
        ...
        // AAML tinyML Lab: optimize this part with SIMD
        ...
        while (col_count)
        {
            ...
            ch_1_out_1 += a1 * b1;
            col_count--;
        } /* while over col_count */ // END AAML tinyML Lab: optimize this part with SIMD
    ...
    if (output_ch & 0x1)
    {
        ...
        while (col_count)
        {
            ...
            ch_0_out_1 += a0 * b1;
            col_count--;
        }// END AAML tinyML Lab: optimize this part with SIMD
        ch_0_out_0 = arm_nn_requantize(ch_0_out_0, *out_mult, *out_shift);
        ch_0_out_0 += out_offset;
        ch_0_out_0 = MAX(ch_0_out_0, activation_min);
        ch_0_out_0 = MIN(ch_0_out_0, activation_max);
